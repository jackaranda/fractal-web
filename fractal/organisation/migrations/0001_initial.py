    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('logo', models.ImageField(storage=django.core.files.storage.FileSystemStorage(location=b'/data/work/projects/research/fractal/website/django/fractal/uploads/organisation/logoes'), upload_to=b'', blank=True)),
